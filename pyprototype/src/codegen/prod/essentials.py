...
class Compiler:
    ...
    target_triple: str
    target: Any
    target_machine: Optional[Any]
    data_layout_obj: Optional[Any]
    ...
    struct_field_visibility: Dict[str, Dict[str, str]]
    ...
    module_loader: Any # ModuleLoaderType
    ...
    def ast_to_fin_type(self, node: Union[str, Node]) -> Any:
        """Converts AST to High-Level Any (for semantic checks)."""
        ...

    def ast_to_fin_type_pattern(self, node: Union[str, Node], generic_params_list: List[Any]) -> Any:
        """Converts AST to Any, treating specific names as Generics (for matching)."""
        ...

    def fin_type_to_llvm(self, fin_type: Any) -> ir.Type:
        """Converts High-Level Any back to LLVM Type."""
        ...

    def infer_fin_type_from_llvm(self, llvm_type: ir.Type) -> Any:
        """Guesses Any from a raw LLVM type."""
        ...
    ...
    def match_generic_types(self, concrete_type: Any, generic_type: Any, bindings: Dict[str, Any]) -> bool:
        """
    ...
    def get_arg_fin_type(compiler: Compiler, ast_node: Node, compiled_val: Optional[ir.Value]) -> Any:
        """
        Determines the High-Level Type (Any) of an argument expression.
        Used during Function Call Type Inference to match arguments against templates.
        """
        ...
    
    def ast_to_fin_type_pattern(compiler: Compiler, node: Union[str, Node], generic_params_list: List[Any]) -> Any:
        """Converts AST to Any, treating specific names as Generics (for matching)."""
        ...
    ...
    def box_value(self, llvm_val: ir.Value, fin_type: Any) -> ir.Value:
        """Allocates memory (malloc) and stores value (Boxing). Returns i8*."""
        ...

    def unbox_value(self, void_ptr: ir.Value, target_fin_type: Any) -> ir.Value:
    ...
    def create_variable_mut(
        ...
        Handles Type Erasure (Any registration) and Type Coercion.
        """
        ...
    ...
    def instantiate_and_compile_generic(
        ...
        inferred_bindings: Dict[str, Any], # Map T -> Any/LLVMType
